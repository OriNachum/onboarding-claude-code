...
- [Automated Briefings](skills/ask/references/stories/automated-briefings.md) — Setting up recurring automated briefings with /loop
...
- [Loop](skills/ask/references/loop.md) — Running recurring tasks with /loop — polling, monitoring, automated briefings
