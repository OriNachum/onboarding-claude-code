...
> **Level: 🌱 Beginner** | **Source:** [Setup](https://docs.anthropic.com/en/docs/claude-code/setup), [Settings](https://docs.anthropic.com/en/docs/claude-code/settings), [Memory](https://docs.anthropic.com/en/docs/claude-code/memory)
...
Once your environment is solid, see [Configuring Your Claude](../intermediate/configuring-your-claude.md) for the ongoing work of building skills, agents, and automation that evolve with your project.
...
See [MCP](../intermediate/mcp.md) for the full guide on when MCP is the right choice vs simpler alternatives.
...
- See [Configuring Your Claude](../intermediate/configuring-your-claude.md) for building skills, agents, hooks, and plugins over time
...
- See [Automating Your Workflows](../intermediate/automating-your-workflows.md) for the automation overview
