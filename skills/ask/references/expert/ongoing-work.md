...
> **Level: 🌳 Expert** | **Source:** [Scheduled Tasks](https://docs.anthropic.com/en/docs/claude-code/scheduled-tasks)
...
This is distinct from [Configuring Your Claude](../intermediate/configuring-your-claude.md), which covers the manual, iterative evolution of your setup. Here we focus on the automated processes that complement that manual work.
...
[Configuring Your Claude](../intermediate/configuring-your-claude.md) describes how your setup evolves through a natural timeline — foundations in weeks 1-2, specialization in months 1-2, maturity at month 3+.
...
- See [GitHub Actions](../intermediate/github-actions.md) for setting up the scheduled workflows that power these patterns
- See [Configuring Your Claude](../intermediate/configuring-your-claude.md) for the manual configuration evolution these automated checks complement
- See [Hooks](../intermediate/hooks.md) for lifecycle automation that can trigger validation on specific events
